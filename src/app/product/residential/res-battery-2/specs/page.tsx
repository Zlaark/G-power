...
export const metadata: Metadata = {
  ...
  description:
    "Complete technical specifications for BYD Battery-Box Premium LVS residential battery system.",
};

export default function ResidentialBattery2SpecsPage() {
  return (
    <main className="min-h-screen bg-[#F3F4F6]">
      <Navbar />

      <section className="px-6 md:px-[60px] lg:px-[100px] py-[70px] lg:py-[100px] animate-slide-left-d3 slow-anim">
        <div className="mx-auto max-w-[980px]">
          <FadeIn delay={80} direction="up">
            ...
            >
              BYD Battery-Box Premium LVS - Complete Technical Documentation
            </p>
          </FadeIn>
            ...
            <div className="mt-12 flex flex-col gap-7">
              ...
              <div className="rounded-[14px] overflow-hidden shadow-[0_10px_22px_rgba(2,8,23,0.1)]">
                <div className="bg-gradient-to-r from-[#081228] via-[#111C32] to-[#132038] px-5 md:px-8 py-8 text-center">
                  ...
                  <Link href="/docs/res-battery-2-datasheet.pdf" passHref>
                  ...
                  >
                    Get the complete 2-page technical datasheet for BYD Battery-Box Premium LVS in PDF format with all specifications, features, and contact information.
                  </p>
          ...
          <FadeIn delay={220} direction="up">
            <div className="mt-8 flex justify-center">
              <Link
                href="/product/residential/res-battery-2"
