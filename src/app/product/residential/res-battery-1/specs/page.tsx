...
export default function ResidentialBattery1SpecsPage() {
  return (
    <main className="min-h-screen bg-[#F3F4F6]">
      ...
      <section className="px-6 md:px-[60px] lg:px-[100px] py-[70px] lg:py-[100px] animate-slide-left-d2 slow-anim">
            ...
            <div className="mt-12 flex flex-col gap-7">
              ...
              <div className="rounded-[14px] overflow-hidden shadow-[0_10px_22px_rgba(2,8,23,0.1)]">
                <div className="bg-gradient-to-r from-[#081228] via-[#111C32] to-[#132038] px-5 md:px-8 py-8 text-center">
                  ...
                  >
                    Get the complete 2-page technical datasheet for BYD Battery-Box Premium HVS in PDF format with all specifications, features, and contact information.
                  </p>
