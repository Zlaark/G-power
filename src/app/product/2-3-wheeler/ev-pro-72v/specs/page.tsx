...
export const metadata: Metadata = {
  ...
  description: "Complete technical specifications for EV Pro Series 72V battery system.",
};
        ...
        <div className="mx-auto max-w-[980px] w-full">
            ...
            <div className="mt-12 flex flex-col gap-7">
              ...
              <div className="rounded-[14px] overflow-hidden shadow-[0_10px_22px_rgba(2,8,23,0.1)]">
                <div className="bg-gradient-to-r from-[#081228] via-[#111C32] to-[#132038] px-5 md:px-8 py-8 text-center">
                  ...
                  <Link href="/docs/ev-pro-72v-datasheet.pdf" passHref>
                  ...
                  <p className="text-white/90 mb-7" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "clamp(14px, 1.1vw, 18px)" }}>Get the complete 2-page technical datasheet for EV Pro Series 72V in PDF format with all specifications, features, and contact information.</p>
          ...
          <FadeIn delay={220} direction="up">
            <div className="mt-8 flex justify-center">
              <Link href="/solutions/2-3-wheeler/products/ev-pro-72v" className="inline-flex items-center gap-2 text-[#0F172A] hover:text-[#EF3C38] transition-colors text-sm md:text-base" style={{ fontFamily: "'Poppins', sans-serif" }}><ArrowLeft className="w-4 h-4" /> Back to Product</Link>
            </div>
          </FadeIn>
        </div>
      </section>
