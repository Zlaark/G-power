      ...
      <div className="relative bg-[#121010] pt-[150px] pb-[80px]">
        ...
        <div className="px-4 text-center relative z-10 max-w-4xl mx-auto">
          <FadeIn delay={80} direction="up">
            ...
            >
              EV Cargo Series 48V - Complete Technical Documentation
            </p>
          </FadeIn>
        </div>
      </div>
        ...
        <div className="mx-auto max-w-[1536px] w-full">
          ...
          <FadeIn delay={220} direction="up">
            <div className="mt-8 flex justify-center">
              <Link href="/solutions/2-3-wheeler/products/ev-cargo-48v" className="inline-flex items-center gap-2 text-[#0F172A] hover:text-[#0A5191] transition-colors text-sm md:text-base" style={{ fontFamily: "'Poppins', sans-serif" }}><ArrowLeft className="w-4 h-4" /> Back to Product</Link>
            </div>
          </FadeIn>
        </div>
      </section>
