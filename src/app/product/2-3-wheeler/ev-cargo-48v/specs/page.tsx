            ...
            <div className="mt-12 flex flex-col gap-7">
              ...
              <div className="rounded-[14px] overflow-hidden shadow-[0_10px_22px_rgba(2,8,23,0.1)]">
                <div className="bg-gradient-to-r from-[#081228] via-[#111C32] to-[#132038] px-5 md:px-8 py-8 text-center">
                  ...
                  <Link href="/docs/ev-cargo-48v-datasheet.pdf" passHref>
                  ...
                  <p className="text-white/90 mb-7" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "clamp(14px, 1.1vw, 18px)" }}>Get the complete 2-page technical datasheet for EV Cargo Series 48V in PDF format with all specifications, features, and contact information.</p>
