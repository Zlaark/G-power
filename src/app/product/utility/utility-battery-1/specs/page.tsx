...
import { UtilityBattery1SpecsCoverSection } from "@/sections/UtilityBattery1SpecsCoverSection";
...
export const metadata: Metadata = {
  title: "Technical Specifications | Utility Battery System 1 | GPower",
  description:
    "Complete technical specifications for Utility Battery System 1 utility battery system.",
};
      ...
      <div className="relative bg-[#121010] pt-[150px] pb-[80px]">
        ...
        <div className="px-4 text-center relative z-10 max-w-4xl mx-auto">
          <FadeIn delay={80} direction="up">
            ...
            >
              Utility Battery System 1 - Complete Technical Documentation
            </p>
          </FadeIn>
        </div>
      </div>
          ...
          <FadeIn delay={140} direction="up">
            <div className="flex flex-col gap-7">
              <div id="datasheet-content" className="grid grid-cols-1 gap-4 lg:gap-7 max-w-4xl mx-auto w-full">
                <UtilityBattery1SpecsCoverSection />
                <UtilityBattery1SpecsSheetSection />
              ...
              <div className="rounded-[14px] overflow-hidden shadow-[0_10px_22px_rgba(2,8,23,0.1)]">
                ...
                >
                  Get the complete 2-page technical datasheet for Utility Battery System 1 in PDF format exactly as shown above, containing all specifications, features, and contact information.
                </p>
                <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
                  <DownloadPdfButton 
                    targetId="datasheet-content" 
                    filename="G-Power-Utility-Battery-System-1-Datasheet.pdf" 
                  />
                  <Link
                    href="/contact"
