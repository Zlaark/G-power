          ...
          <FadeIn delay={140} direction="up">
            <div className="flex flex-col gap-7">
              ...
              <div className="rounded-[14px] overflow-hidden shadow-[0_10px_22px_rgba(2,8,23,0.1)]">
                ...
                >
                  Get the complete 2-page technical datasheet for BYD MC Cube in PDF format exactly as shown above, containing all specifications, features, and contact information.
                </p>
                  <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
                  <DownloadPdfButton 
                    targetId="datasheet-content" 
                    filename="G-Power-BYD-MC-Cube-Datasheet.pdf" 
                  />
                  <Link
                    href="/contact"
