...
import { CIBattery2SpecsCoverSection } from "@/sections/CIBattery2SpecsCoverSection";
import { CIBattery2SpecsSheetSection } from "@/sections/CIBattery2SpecsSheetSection";

export const metadata: Metadata = {
  title: "Technical Specifications | BYD MC Cube | GPower",
  description:
    "Complete technical specifications for BYD MC Cube energy storage system.",
};

export default function CIBattery2SpecsPage() {
  return (
    <main className="min-h-screen bg-[#F3F4F6]">
      <Navbar />

      <section className="px-6 md:px-[60px] lg:px-[100px] py-[70px] lg:py-[100px] animate-badge-pop-d1 slow-anim">
        <div className="mx-auto max-w-[980px]">
          <FadeIn delay={80} direction="up">
            ...
            >
              BYD MC Cube - Complete Technical Documentation
            </p>
          </FadeIn>

          <FadeIn delay={140} direction="up">
            <div className="mt-12 flex flex-col gap-7">
              <CIBattery2SpecsCoverSection />
              <CIBattery2SpecsSheetSection />
              ...
              <div className="rounded-[14px] overflow-hidden shadow-[0_10px_22px_rgba(2,8,23,0.1)]">
                <div className="bg-gradient-to-r from-[#081228] via-[#111C32] to-[#132038] px-5 md:px-8 py-8 text-center">
                  ...
                  <Link href="/docs/ci-battery-2-datasheet.pdf" passHref>
                  ...
                  >
                    Get the complete 2-page technical datasheet for BYD MC Cube in PDF format with all specifications, features, and contact information.
                  </p>
