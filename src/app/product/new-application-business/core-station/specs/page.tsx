        ...
        <div className="mx-auto max-w-[1536px] w-full">
          ...
          <FadeIn delay={220} direction="up">
            <div className="mt-8 flex justify-center">
              <Link href="/solutions/new-application-business/products/core-station" className="inline-flex items-center gap-2 text-[#0F172A] hover:text-[#0A5191] transition-colors text-sm md:text-base" style={{ fontFamily: "'Poppins', sans-serif" }}><ArrowLeft className="w-4 h-4" /> Back to Product</Link>
            </div>
          </FadeIn>
        </div>
      </section>
