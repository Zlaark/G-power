          ...
          <FadeIn delay={140} direction="up">
            <div className="mt-12 flex flex-col gap-7">
              ...
              <div className="rounded-[14px] overflow-hidden shadow-[0_10px_22px_rgba(2,8,23,0.1)]">
                ...
                >
                  Get the complete 2-page technical datasheet for Enterprise Power Hub in PDF format exactly as shown above, containing all specifications, features, and contact information.
                </p>
