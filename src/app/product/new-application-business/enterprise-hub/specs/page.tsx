...
export const metadata: Metadata = {
  ...
  description: "Complete technical specifications for Enterprise Power Hub energy storage system.",
};

export default function EnterpriseHubSpecsPage() {
  return (
      ...
      <section className="px-3 sm:px-6 md:px-[30px] lg:px-[60px] py-[40px] md:py-[70px] lg:py-[100px]">
        <div className="mx-auto max-w-[980px] w-full">
          <FadeIn delay={80} direction="up">
            ...
            <p className="text-[#475569] text-center" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "clamp(14px, 1.2vw, 22px)" }}>Enterprise Power Hub - Complete Technical Documentation</p>
          </FadeIn>
            ...
            <div className="mt-12 flex flex-col gap-7">
              ...
              <div className="rounded-[14px] overflow-hidden shadow-[0_10px_22px_rgba(2,8,23,0.1)]">
                <div className="bg-gradient-to-r from-[#081228] via-[#111C32] to-[#132038] px-5 md:px-8 py-8 text-center">
                  ...
                  <Link href="/docs/enterprise-hub-datasheet.pdf" passHref>
                  ...
                  <p className="text-white/90 mb-7" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "clamp(14px, 1.1vw, 18px)" }}>Get the complete 2-page technical datasheet for Enterprise Power Hub in PDF format with all specifications, features, and contact information.</p>
