...
export const metadata: Metadata = {
  title: "BYD MC Cube | Commercial & Industrial Solutions | GPower",
  description:
    "Medium-sized containerized solution for commercial applications. 1.1 MWh capacity, 500 kW power, and ≥90% efficiency.",
};

const specs = [
  { label: "Capacity", value: "1.1 MWh" },
  { label: "Power", value: "500 kW" },
  { label: "Voltage Range", value: "800-1100 VDC" },
  { label: "Efficiency", value: "≥90%" },
];

const applications = [
  { label: "Factory energy management" },
  { label: "Shopping mall backup" },
...
const technicalParams = [
  { param: "Capacity", value: "1.1 MWh" },
  { param: "Power", value: "500 kW" },
  { param: "Voltage Range", value: "800-1100 VDC" },
  { param: "Efficiency", value: "≥90%" },
  { param: "System Type", value: "Containerized commercial storage system" },
  { param: "Monitoring", value: "Cloud-based remote monitoring" },
  ...
  { param: "Maintenance", value: "Low-maintenance design" },
];

export default function CIBattery2Page() {
  return (
      ...
      <section className="relative h-[60vh] min-h-[420px] md:h-[72vh] md:min-h-[540px] flex items-center justify-center bg-[#0D0D0D] overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-6">
          ...
          <FadeIn delay={320} direction="up">
            <p
              className="text-white/80 max-w-[760px]"
              style={{ fontFamily: "'Poppins', sans-serif", fontSize: "clamp(14px, 1.5vw, 18px)" }}
            >
              Medium-sized containerized solution for commercial applications
            </p>
          </FadeIn>
        </div>
      </section>
      ...
      <section className="py-[72px] lg:py-[100px] px-6 md:px-[60px] lg:px-[100px] bg-[#F9FAFB]">
        <div className="mx-auto max-w-[920px]">
          <FadeIn delay={100} direction="up">
            ...
            >
              Detailed specifications for BYD MC Cube
            </p>
          </FadeIn>
            ...
            <div className="rounded-[20px] overflow-hidden bg-white shadow-[0_12px_28px_rgba(2,8,23,0.10)] section-soft-hover">
              ...
              <div className="px-6 md:px-8 py-6 md:py-7 bg-gradient-to-r from-[#081228] via-[#111C32] to-[#132038] text-center">
                ...
                <Link
                  ...
                  className="btn-sweep-blue btn-float-hover inline-flex items-center gap-2 bg-[#0A5191] text-white px-7 py-4 rounded-[14px] font-normal hover:bg-[#083D6D] transition-colors shadow-[0_8px_18px_rgba(10, 81, 145,0.22)]"
      ...
      <section className="relative py-[80px] lg:py-[112px] px-6 md:px-[60px] lg:px-[100px] overflow-hidden bg-[#0D0D0D]">
        <div className="absolute inset-0 z-0 pointer-events-none select-none">
          <Image
            ...
            alt="Commercial industrial energy system"
            fill
        ...
        <div className="relative z-10 mx-auto max-w-[800px] text-center">
          ...
          <FadeIn delay={300} direction="up">
            <Link
              href="/contact"
              className="btn-sweep-blue btn-float-hover inline-flex items-center justify-center bg-[#0A5191] text-white px-10 py-4 rounded-[14px] font-medium hover:bg-white hover:text-[#0A5191] transition-all hover:scale-105 hover:shadow-xl"
