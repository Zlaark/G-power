    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="pt-[170px] pb-[64px] px-4 sm:px-6 md:px-[90px] lg:px-[120px] bg-[#121010]">
        <div className="mx-auto max-w-[1200px] text-center">
          <FadeIn delay={120} direction="up"><p className="text-white/85 font-medium tracking-[0.16em] uppercase mb-5" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "13px" }}>Commercial & Industrial</p></FadeIn>
          ...
          <FadeIn delay={320} direction="up"><p className="text-white/80 font-medium mx-auto max-w-3xl" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "clamp(14px, 1.7vw, 20px)" }}>Browse our complete range of commercial & industrial products</p></FadeIn>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-[1300px]">
          ...
          <FadeIn delay={400} direction="up">
            <div className="mt-[48px] flex justify-center">
              <Link href="/solutions/commercial-industrial" className="inline-flex items-center gap-2 text-[#475569] hover:text-[#EF3C38] transition-colors" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "15px" }}><ArrowLeft className="w-4 h-4" /> Back to Commercial & Industrial</Link>
            </div>
          </FadeIn>
        </div>
      </section>
