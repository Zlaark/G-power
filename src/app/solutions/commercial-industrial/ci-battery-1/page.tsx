...
export const metadata: Metadata = {
  title: "BYD Battery-Box Commercial | Commercial & Industrial Solutions | GPower",
  description:
    "Scalable energy storage solution for commercial and industrial applications. 215 kWh capacity, 100 kW power, and ≥92% efficiency.",
};

const specs = [
  { label: "Capacity", value: "215 kWh" },
  { label: "Power", value: "100 kW" },
  { label: "Voltage Range", value: "672-907 VDC" },
...
const keyMerits = [
  { label: "Modular design for easy expansion" },
  { label: "High cycle life" },
...
const technicalParams = [
  ...
  { param: "System Type", value: "Commercial modular battery cabinet" },
  ...
  { param: "Expansion", value: "Modular scalable architecture" },
];

import { PageHero } from "@/components/PageHero";

export default function CIBattery1Page() {
  return (
...
<FadeIn delay={100} direction="up" className="w-full">
              <div className="relative w-full rounded-[20px] overflow-hidden border border-[#0A5191]/35 card-soft-hover" style={{ aspectRatio: "3/2.2" }}>
                <Image
                  ...
                  alt="BYD Battery-Box Commercial"
                  fill
      ...
      <section className="relative py-[80px] lg:py-[112px] px-6 md:px-[60px] lg:px-[100px] overflow-hidden bg-[#0D0D0D]">
        ...
        <div className="relative z-10 mx-auto max-w-[800px] text-center">
          <FadeIn delay={100} direction="up">
            ...
            >
              Interested in BYD Battery-Box Commercial?
            </h2>
          </FadeIn>
