        ...
        <div className="mx-auto max-w-[1300px]">
          ...
          <FadeIn delay={400} direction="up">
            <div className="mt-[48px] flex justify-center">
              <Link href="/solutions/new-application-business" className="inline-flex items-center gap-2 text-[#475569] hover:text-[#EF3C38] transition-colors" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "15px" }}><ArrowLeft className="w-4 h-4" /> Back to New Application Business</Link>
            </div>
          </FadeIn>
        </div>
      </section>
