...
export default function NewApplicationBusinessPage() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <PageHero 
        title="Marine & Other Applications" 
        breadcrumbPage="Marine & Other Applications" 
        backgroundImage="/Battery Energy Storage Systems (BESS)  (About Us Page).webp" 
        description="Enterprise-grade storage systems for specialized sectors like marine, drones, and railway infrastructure."
      />
              ...
              <FadeIn delay={180 + index * 90} direction="up" key={product.title}>
                <article className="group card-shimmer card-border-glow rounded-[18px] overflow-hidden border border-[#121010]/10 bg-[#F9FAFB] h-full min-h-0 lg:min-h-[580px] flex flex-col transition-all duration-700 ease-in-out hover:shadow-xl md:hover:shadow-2xl md:hover:-translate-y-2 md:hover:-translate-x-1 hover:border-[#0A5191]/20">
                  ...
                  <div className="p-[16px] sm:p-[22px] lg:p-[24px] flex flex-col flex-1">
                    ...
                    <Link
                      href={product.href}
                      className="mt-auto inline-flex items-center gap-2 w-fit text-[#0A5191] font-medium hover:text-[#4a90e2] transition-all duration-500 ease-in-out md:group-hover:gap-4"
