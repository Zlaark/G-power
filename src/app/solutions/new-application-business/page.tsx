    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative h-[52vh] min-h-[360px] sm:min-h-[430px] md:h-[65vh] md:min-h-[520px] flex items-center justify-center bg-[#121010] overflow-hidden pt-20">
        <div className="absolute inset-0 z-0 select-none pointer-events-none">
          <Image src="https://images.unsplash.com/photo-1558981420-c532902e58b4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1920" alt="Modern Business Infrastructure" fill priority className="object-cover opacity-50 brightness-75" />
        ...
        <div className="container relative z-10 px-4 sm:px-6 md:px-[60px] lg:px-[80px] mx-auto text-center max-w-5xl">
          ...
          <FadeIn delay={340} direction="up">
            <p className="text-white/80 max-w-3xl mx-auto font-medium" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "clamp(14px, 1.8vw, 22px)" }}>Choose how you&apos;d like to explore our enterprise energy storage offerings</p>
          </FadeIn>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-[1100px]">
          <FadeIn delay={100} direction="up">
            <div className="text-center mb-[48px] lg:mb-[64px]">
              ...
              <p className="text-[#475569] font-medium" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "clamp(14px, 1.5vw, 18px)" }}>Dive into our enterprise solutions or browse individual products</p>
            </div>
          </FadeIn>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-[20px] lg:gap-[28px]">
            <FadeIn delay={180} direction="up">
              <Link href="/solutions/new-application-business/solution" className="group card-shimmer card-border-glow block rounded-[20px] border border-[#121010]/10 bg-white overflow-hidden h-full min-h-[340px] lg:min-h-[420px] flex flex-col">
                <div className="relative h-[180px] lg:h-[220px] w-full overflow-hidden">
                  <Image src="https://images.unsplash.com/photo-1758957851828-5179f0e06985?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800" alt="Enterprise Solutions" fill className="object-cover transition-transform duration-700 group-hover:scale-[1.06]" />
                ...
                <div className="p-[24px] lg:p-[28px] flex flex-col flex-1">
                  ...
                  <p className="text-[#475569] font-medium leading-[1.65] mb-[18px]" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "clamp(13px, 1.2vw, 16px)" }}>Complete enterprise solution overview with product merits, recommended products, project case studies, and expert consultation.</p>
            ...
            <FadeIn delay={280} direction="up">
              <Link href="/solutions/new-application-business/products" className="group card-shimmer card-border-glow block rounded-[20px] border border-[#121010]/10 bg-white overflow-hidden h-full min-h-[340px] lg:min-h-[420px] flex flex-col">
                <div className="relative h-[180px] lg:h-[220px] w-full overflow-hidden">
                  <Image src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800" alt="Enterprise Products" fill className="object-cover transition-transform duration-700 group-hover:scale-[1.06]" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent" />
                ...
                <div className="p-[24px] lg:p-[28px] flex flex-col flex-1">
                  ...
                  <p className="text-[#475569] font-medium leading-[1.65] mb-[18px]" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "clamp(13px, 1.2vw, 16px)" }}>Browse all enterprise storage products with specifications, technical parameters, and downloadable datasheets.</p>
