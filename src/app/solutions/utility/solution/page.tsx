...
export default function UtilitySolutionsPage() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <PageHero 
        title="Utility Energy Storage" 
        breadcrumbPage="Utility Energy Storage" 
        backgroundImage="/Battery Energy Storage Systems (BESS)  (About Us Page).webp" 
        description="Advanced storage systems for renewable integration, grid stability, and utility-grade performance."
      />
