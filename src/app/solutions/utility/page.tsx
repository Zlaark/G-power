...
export const metadata: Metadata = {
  title: "Utility | GPower",
  description: "Explore utility-scale energy storage solutions and products.",
};
        ...
        <div className="mx-auto max-w-[1100px]">
          <FadeIn delay={100} direction="up">
            <div className="text-center mb-[48px] lg:mb-[64px]">
              ...
              <p className="text-[#475569] font-medium" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "clamp(14px, 1.5vw, 18px)" }}>Dive into our utility-scale solutions or browse individual products</p>
            </div>
          </FadeIn>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-[20px] lg:gap-[28px]">
            <FadeIn delay={180} direction="up">
              <Link href="/solutions/utility/solution" className="group card-shimmer card-border-glow block rounded-[20px] border border-[#121010]/10 bg-white overflow-hidden h-full min-h-[340px] lg:min-h-[420px] flex flex-col">
                <div className="relative h-[180px] lg:h-[220px] w-full overflow-hidden">
                  <Image src="https://images.unsplash.com/photo-1466611653911-95081537e5b7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800" alt="Utility Solutions" fill className="object-cover transition-transform duration-700 group-hover:scale-[1.06]" />
                ...
                <div className="p-[24px] lg:p-[28px] flex flex-col flex-1">
                  ...
                  <p className="text-[#475569] font-medium leading-[1.65] mb-[18px]" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "clamp(13px, 1.2vw, 16px)" }}>Comprehensive utility-scale solution overview with deployment process, scale statistics, and expert consultation.</p>
            ...
            <FadeIn delay={280} direction="up">
              <Link href="/solutions/utility/products" className="group card-shimmer card-border-glow block rounded-[20px] border border-[#121010]/10 bg-white overflow-hidden h-full min-h-[340px] lg:min-h-[420px] flex flex-col">
                <div className="relative h-[180px] lg:h-[220px] w-full overflow-hidden">
                  <Image src="https://images.unsplash.com/photo-1509391366360-2e959784a276?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800" alt="Utility Products" fill className="object-cover transition-transform duration-700 group-hover:scale-[1.06]" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent" />
                ...
                <div className="p-[24px] lg:p-[28px] flex flex-col flex-1">
                  ...
                  <p className="text-[#475569] font-medium leading-[1.65] mb-[18px]" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "clamp(13px, 1.2vw, 16px)" }}>Browse all utility-scale battery products with specifications, technical parameters, and downloadable datasheets.</p>
