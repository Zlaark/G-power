      ...
      <section className="relative h-auto min-h-[380px] sm:min-h-[430px] md:h-[65vh] md:min-h-[520px] flex items-center justify-center bg-[#121010] overflow-hidden pt-[140px] pb-[50px] sm:pt-[150px] sm:pb-[60px] md:pt-20 md:pb-0">
        ...
        <div className="container relative z-10 px-5 sm:px-6 md:px-[60px] lg:px-[80px] mx-auto text-center max-w-5xl">
          <FadeIn delay={50} direction="up">
            <LegalBreadcrumbs currentPage="Utility Products" />
          </FadeIn>
          ...
          <FadeIn delay={400} direction="up" duration={900}>
            ...
            >
              Browse our complete range of utility-scale energy storage products
            </p>
          </FadeIn>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-[1300px]">
          ...
          <FadeIn delay={400} direction="up">
            <div className="mt-[48px] flex justify-center">
              <Link href="/solutions/utility" className="inline-flex items-center gap-2 text-[#475569] hover:text-[#0A5191] transition-colors" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "15px" }}><ArrowLeft className="w-4 h-4" /> Back to Utility</Link>
            </div>
          </FadeIn>
        </div>
      </section>
