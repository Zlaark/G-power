...
export const metadata: Metadata = {
  ...
  description: "Explore energy storage solutions and products for electric 2 and 3 wheelers.",
};
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative h-[52vh] min-h-[360px] sm:min-h-[430px] md:h-[65vh] md:min-h-[520px] flex items-center justify-center bg-[#121010] overflow-hidden pt-20">
        <div className="absolute inset-0 z-0 select-none pointer-events-none">
          <Image src="https://images.unsplash.com/photo-1558981420-c532902e58b4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1920" alt="Electric Two and Three Wheeler" fill priority className="object-cover opacity-50 brightness-75" />
        ...
        <div className="container relative z-10 px-4 sm:px-6 md:px-[60px] lg:px-[80px] mx-auto text-center max-w-5xl">
          <FadeIn delay={120} direction="up">
            <p className="text-white/85 font-medium tracking-[0.16em] uppercase mb-5" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "13px" }}>2 & 3 Wheeler Energy Storage</p>
          </FadeIn>
          <FadeIn delay={220} direction="up">
            <h1 className="text-white font-semibold leading-tight mb-5" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "clamp(34px, 6vw, 64px)" }}>Power Your EV, Reliably</h1>
          </FadeIn>
          <FadeIn delay={340} direction="up">
            <p className="text-white/80 max-w-3xl mx-auto font-medium" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "clamp(14px, 1.8vw, 22px)" }}>Choose how you&apos;d like to explore our EV battery storage offerings</p>
          </FadeIn>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-[1100px]">
          <FadeIn delay={100} direction="up">
            <div className="text-center mb-[48px] lg:mb-[64px]">
              ...
              <p className="text-[#475569] font-medium" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "clamp(14px, 1.5vw, 18px)" }}>Dive into our EV battery solutions or browse individual products</p>
            </div>
          </FadeIn>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-[20px] lg:gap-[28px]">
            <FadeIn delay={180} direction="up">
              <Link href="/solutions/2-3-wheeler/solution" className="group card-shimmer card-border-glow block rounded-[20px] border border-[#121010]/10 bg-white overflow-hidden h-full min-h-[340px] lg:min-h-[420px] flex flex-col">
            ...
            <FadeIn delay={280} direction="up">
              <Link href="/solutions/2-3-wheeler/products" className="group card-shimmer card-border-glow block rounded-[20px] border border-[#121010]/10 bg-white overflow-hidden h-full min-h-[340px] lg:min-h-[420px] flex flex-col">
                <div className="relative h-[180px] lg:h-[220px] w-full overflow-hidden">
