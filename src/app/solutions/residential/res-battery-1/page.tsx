...
export const metadata: Metadata = {
  title: "BYD Battery-Box Premium HVS | Residential Solutions | GPower",
  description:
    "Premium home energy storage system with high voltage design. 16.6 kWh capacity, 5 kW power, and ≥96% efficiency.",
};
...
const technicalParams = [
  ...
  { param: "Mounting", value: "Floor-standing / wall-adjacent" },
  { param: "Operating Temperature", value: "-10°C to +50°C" },
  { param: "Protection Class", value: "IP55" },
  { param: "Communication", value: "CAN / RS485" },
  { param: "Warranty", value: "10 Years" },
];

export default function ResidentialBattery1Page() {
  return (
        ...
        <div className="mx-auto max-w-[980px]">
          <FadeIn delay={100} direction="up">
            <h2
              ...
              style={{ fontFamily: "'Poppins', sans-serif", fontSize: "clamp(28px, 3.6vw, 44px)" }}
            >
            ...
            >
              Detailed specifications for BYD Battery-Box Premium HVS
            </p>
          </FadeIn>
      ...
      <section className="relative py-[80px] lg:py-[112px] px-6 md:px-[60px] lg:px-[100px] overflow-hidden bg-[#0D0D0D]">
        ...
        <div className="relative z-10 mx-auto max-w-[800px] text-center">
          <FadeIn delay={100} direction="up">
            ...
            >
              Interested in BYD Battery-Box Premium HVS?
            </h2>
          </FadeIn>
          <FadeIn delay={200} direction="up">
            <p
