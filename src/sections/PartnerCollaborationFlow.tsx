                ...
                <FadeIn key={point.title} delay={200 + index * 90} direction="up">
                  <div className="group pb-2 transition-transform duration-500 hover:translate-x-2">
                    <div className="flex items-start gap-4">
                      <div className="w-3 h-3 rounded-full bg-[#EF3C38] shrink-0 mt-3 transition-transform duration-500 group-hover:scale-125 group-hover:shadow-[0_0_0_6px_rgba(239,60,56,0.08)]" />
