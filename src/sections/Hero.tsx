    ...
    return (
        <section className="relative overflow-hidden bg-[#0A0A0A] text-white pt-32 pb-20 lg:pt-48 lg:pb-32">
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[500px] opacity-30 pointer-events-none">
                <div className="absolute inset-0 bg-gradient-to-b from-[#0A5191]/40 to-transparent blur-[100px] rounded-full mix-blend-screen" />
            </div>

            <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-5xl">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-[#0A5191] text-sm font-medium mb-8">
                    <span className="relative flex h-2 w-2">
                        <span className="absolute inline-flex h-full w-full rounded-full bg-[#0A5191] opacity-75"></span>
                        <span className="relative inline-flex rounded-full h-2 w-2 bg-[#0A5191]"></span>
                    </span>
                ...
                <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-8 bg-clip-text text-transparent bg-gradient-to-r from-white via-white to-white/60">
                    ...
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0A5191] to-[#0A5191]/80">of web applications.</span>
                </h1>
