...
const generalParameters = [
  { key: "Usable Energy", value: "16.6 kWh" },
  { key: "Rated Power", value: "5 kW" },
  { key: "Operating Voltage Range", value: "192-460 VDC" },
  { key: "Round Trip Efficiency", value: "≥96%" },
...
export function ResidentialBattery1SpecsSheetSection() {
  return (
