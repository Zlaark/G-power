...
export function EVPro72VSpecsCoverSection() {
  return (
    <section className="rounded-[14px] bg-[#F5F6F8] border border-[#E7EAF0] overflow-hidden mb-7">
      <div className="bg-gradient-to-r from-[#EF3C38] to-[#D7282B] px-6 md:px-8 py-6 md:py-7">
        ...
        >
          High-performance swappable battery pack for electric scooters and motorcycles
        </p>
      </div>
      ...
      <div className="p-6 md:p-8">
        <div className="relative w-full rounded-[12px] overflow-hidden mb-6" style={{ aspectRatio: "16/5.3" }}>
          <Image
            src="https://images.unsplash.com/photo-1558981403-c5f9899a28bc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1400"
            alt="EV Pro Series 72V"
            fill
