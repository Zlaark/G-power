    ...
    <section className="rounded-[14px] bg-[#F5F6F8] border border-[#E7EAF0] overflow-hidden flex flex-col justify-between card-shimmer card-soft-hover">
      ...
      <div className="rounded-[10px] bg-[#F0F2F5] border border-[#E3E7EE] p-4 md:p-5 mb-7">
        ...
        <div className="flex flex-col gap-2">
          {terms.map((term) => (
            <p key={term} className="text-[#475569] transition-transform duration-300 hover:translate-x-2 hover:text-[#0A5191]" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "clamp(12px, 0.95vw, 14px)" }}>• {term}</p>
          ))}
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-7">
        <div className="flex items-start gap-3">
          <span className="w-8 h-8 rounded-[8px] bg-[#E1EBF5] flex items-center justify-center shrink-0"><Mail className="w-4 h-4 text-[#0A5191]" /></span>
