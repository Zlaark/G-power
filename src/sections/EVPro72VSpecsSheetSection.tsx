...
const generalParameters = [
  { key: "Nominal Capacity", value: "3.2 kWh" },
  { key: "Nominal Voltage", value: "72 VDC" },
  { key: "Max Continuous Discharge", value: "60 A" },
  { key: "Max Charging Current", value: "30 A" },
  { key: "Operating Temperature", value: "-10°C to +55°C" },
];

const physicalSpecifications = [
  { key: "Weight", value: "18.5 kg" },
  { key: "Dimensions (L×W×H)", value: "320×220×280 mm" },
  { key: "Protection Rating", value: "IP67" },
  { key: "Cell Chemistry", value: "LFP (LiFePO₄)" },
  { key: "Cycle Life", value: "≥2000 cycles @ 80% DOD" },
];
    ...
    <section className="rounded-[14px] bg-[#F5F6F8] border border-[#E7EAF0] p-5 md:p-8 card-shimmer card-soft-hover">
          ...
          <tbody>
            {generalParameters.map((row, index) => (
              <tr key={row.key} className={index % 2 === 0 ? "bg-[#F0F2F5]" : "bg-[#EAEEF2]"}>
                <td className="px-4 md:px-5 py-3 text-[#0F172A] border-r border-[#D9DEE7] w-3/5" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "clamp(13px, 1vw, 15px)" }}>{row.key}</td>
                <td className="px-4 md:px-5 py-3 text-[#334155]" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "clamp(13px, 1vw, 15px)" }}>{row.value}</td>
              </tr>
            ))}
          </tbody>
        </table>
      ...
      <div className="rounded-[10px] bg-[#F0F2F5] border border-[#E3E7EE] p-4 md:p-5 mb-7">
        ...
        <div className="flex flex-col gap-2">
          {terms.map((term) => (
            <p key={term} className="text-[#475569] transition-transform duration-300 hover:translate-x-2 hover:text-[#EF3C38]" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "clamp(12px, 0.95vw, 14px)" }}>• {term}</p>
          ))}
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-7">
        <div className="flex items-start gap-3">
          <span className="w-8 h-8 rounded-[8px] bg-[#FBEBEC] flex items-center justify-center shrink-0"><Mail className="w-4 h-4 text-[#EF3C38]" /></span>
          <div><p className="text-[#94A3B8] leading-none mb-1" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "11px" }}>Email</p><p className="text-[#0F172A]" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "clamp(12px, 0.95vw, 14px)" }}>info@gpower.com</p></div>
        </div>
        <div className="flex items-start gap-3">
          <span className="w-8 h-8 rounded-[8px] bg-[#FBEBEC] flex items-center justify-center shrink-0"><Phone className="w-4 h-4 text-[#EF3C38]" /></span>
        ...
        <div className="flex items-start gap-3">
          <span className="w-8 h-8 rounded-[8px] bg-[#FBEBEC] flex items-center justify-center shrink-0"><MapPin className="w-4 h-4 text-[#EF3C38]" /></span>
          <div><p className="text-[#94A3B8] leading-none mb-1" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "11px" }}>Location</p><p className="text-[#0F172A]" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "clamp(12px, 0.95vw, 14px)" }}>India</p></div>
        </div>
      </div>
