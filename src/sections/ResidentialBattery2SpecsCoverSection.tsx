...
export function ResidentialBattery2SpecsCoverSection() {
  return (
    <section className="rounded-[14px] bg-[#F5F6F8] border border-[#E7EAF0] overflow-hidden mb-7">
      ...
      <div className="p-6 md:p-8">
        <div className="relative w-full rounded-[12px] overflow-hidden mb-6" style={{ aspectRatio: "16/5.3" }}>
          <Image
            src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1400"
