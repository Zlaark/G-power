            ...
            <div className="max-w-[1200px] w-full">
                <FadeIn delay={100} direction="up">
                    <div className="space-y-12">
                        <section>
                            <h2 className="text-3xl font-bold mb-4 text-[#121010]" style={{ fontFamily: "'Montserrat', sans-serif" }}>General Information</h2>
                        ...
                        <section>
                            <h2 className="text-3xl font-bold mb-4 text-[#121010]" style={{ fontFamily: "'Montserrat', sans-serif" }}>Professional Advice</h2>
                            <p className="text-lg leading-relaxed text-[#4A4A4A]" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                        ...
                        <section>
                            <h2 className="text-3xl font-bold mb-4 text-[#121010]" style={{ fontFamily: "'Montserrat', sans-serif" }}>Performance Estimates</h2>
                            <p className="text-lg leading-relaxed text-[#4A4A4A]" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                            ...
                            <p className="mt-4 text-lg leading-relaxed text-[#4A4A4A]" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                        ...
                        <section>
                            <h2 className="text-3xl font-bold mb-4 text-[#121010]" style={{ fontFamily: "'Montserrat', sans-serif" }}>External Links</h2>
                            <p className="text-lg leading-relaxed text-[#4A4A4A]" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                        ...
                        <section>
                            <h2 className="text-3xl font-bold mb-4 text-[#121010]" style={{ fontFamily: "'Montserrat', sans-serif" }}>Product Specifications</h2>
                            <p className="text-lg leading-relaxed text-[#4A4A4A]" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                        ...
                        <section>
                            <h2 className="text-3xl font-bold mb-4 text-[#121010]" style={{ fontFamily: "'Montserrat', sans-serif" }}>Government Subsidies and Incentives</h2>
                            <p className="text-lg leading-relaxed text-[#4A4A4A]" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                        ...
                        <section>
                            <h2 className="text-3xl font-bold mb-4 text-[#121010]" style={{ fontFamily: "'Montserrat', sans-serif" }}>Technical Limitations</h2>
                            <p className="text-lg leading-relaxed text-[#4A4A4A]" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                        ...
                        <section>
                            <h2 className="text-3xl font-bold mb-4 text-[#121010]" style={{ fontFamily: "'Montserrat', sans-serif" }}>Availability</h2>
                            <p className="text-lg leading-relaxed text-[#4A4A4A]" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                        ...
                        <section>
                            <h2 className="text-3xl font-bold mb-4 text-[#121010]" style={{ fontFamily: "'Montserrat', sans-serif" }}>Limitation of Liability</h2>
                            <p className="text-lg leading-relaxed text-[#4A4A4A]" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                        ...
                        <section>
                            <h2 className="text-3xl font-bold mb-4 text-[#121010]" style={{ fontFamily: "'Montserrat', sans-serif" }}>Revisions</h2>
                            <p className="text-lg leading-relaxed text-[#4A4A4A]" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                        ...
                        <section className="pt-8 border-t border-gray-200">
                            <h2 className="text-3xl font-bold mb-4 text-[#121010]" style={{ fontFamily: "'Montserrat', sans-serif" }}>Contact Us</h2>
                            <p className="text-lg leading-relaxed text-[#4A4A4A]" style={{ fontFamily: "'Montserrat', sans-serif" }}>
