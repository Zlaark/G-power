                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-5 items-start mb-10">
                        ...
                        <FadeIn delay={200} direction="up" className="lg:col-span-3 flex flex-col lg:items-start lg:text-left order-2 lg:order-1 lg:pt-4 w-full border-t lg:border-t-0 border-white/5 pt-6 lg:pr-5">
                            ...
                            <ul className="flex flex-col gap-3 w-full">
                                {quickLinks.map(item => (
                                    <li key={item.name} className="w-full">
                                        <Link href={item.path} className="text-white/60 hover:text-white transition-all duration-500 font-light text-[15px] hover:tracking-widest inline-block whitespace-nowrap">
                                            {item.name}
                                        </Link>
                                    </li>
                                ))}
                            ...
                            <div className="w-full mt-5 pt-5 border-t border-white/10">
                                <h4 className="text-[#0A5191] text-[11px] tracking-[0.35em] uppercase font-bold mb-4">Connect</h4>
                                <ul className="flex flex-col gap-3 w-full">
                                    {legalLinks.map(item => (
                                        <li key={item.name} className="w-full">
                                            <Link href={item.path} className="text-white/60 hover:text-white transition-all duration-500 font-light text-[15px] hover:tracking-widest inline-block whitespace-nowrap">
