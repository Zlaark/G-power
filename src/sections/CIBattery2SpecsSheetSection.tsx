...
const generalParameters = [
  { key: "Rated Energy", value: "1.1 MWh" },
  { key: "Rated Power", value: "500 kW" },
  { key: "Operating Voltage Range", value: "800-1100 VDC" },
  { key: "Round Trip Efficiency", value: "≥90%" },
];
...
export function CIBattery2SpecsSheetSection() {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-7">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-[#0F172A]" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "clamp(12px, 0.95vw, 14px)" }}>info@gpower.com</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-[#0F172A]" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "clamp(12px, 0.95vw, 14px)" }}>India</p>
          </div>
        </div>
      </div>

      <p className="text-center text-[#64748B]" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "clamp(12px, 0.95vw, 14px)" }}>
        Page 2 of 2
      </p>
    </section>
  );
