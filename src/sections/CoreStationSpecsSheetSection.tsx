...
const generalParameters = [
  { key: "Nominal Energy", value: "50 kWh" },
  { key: "Rated Power", value: "25 kW" },
  { key: "Operating Voltage Range", value: "350-450 VDC" },
  { key: "Round Trip Efficiency", value: "≥97.5%" },
  { key: "Operating Temperature", value: "-20°C to +50°C" },
];

const physicalSpecifications = [
  { key: "Dimensions (W×D×H)", value: "1200×1000×2100 mm" },
  { key: "Footprint", value: "1.2 sq m" },
  { key: "Weight", value: "650 kg" },
  { key: "Protection Rating", value: "IP55" },
  { key: "Cooling Method", value: "Smart Forced Air Cooling" },
];
...
export function CoreStationSpecsSheetSection() {
  return (
    <section className="rounded-[14px] bg-[#F5F6F8] border border-[#E7EAF0] overflow-hidden flex flex-col justify-between card-shimmer card-soft-hover">
      ...
      <h4 className="text-[#0F172A] font-semibold mb-3" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "clamp(15px, 1.2vw, 18px)" }}>Physical Specifications</h4>
      <div className="rounded-[8px] overflow-hidden border border-[#D9DEE7] mb-6">
        <table className="w-full"><tbody>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-7">
        ...
        <div className="flex items-start gap-3"><span className="w-8 h-8 rounded-[8px] bg-[#E1EBF5] flex items-center justify-center shrink-0"><Phone className="w-4 h-4 text-[#0A5191]" /></span><div><p className="text-[#94A3B8] leading-none mb-1" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "11px" }}>Phone</p><p className="text-[#0F172A]" style={{ fontFamily: "'Poppins', sans-serif", fontSize: "clamp(12px, 0.95vw, 14px)" }}>+91 9894277915</p></div></div>
