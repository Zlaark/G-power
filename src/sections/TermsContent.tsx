            ...
            <div className="max-w-[1200px] w-full">
                <FadeIn delay={100} direction="up">
                    <div className="space-y-8 md:space-y-12">
                        <section>
                            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-[#121010]" style={{ fontFamily: "'Montserrat', sans-serif" }}>1. Acceptance of Terms</h2>
                        ...
                        <section>
                            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-[#121010]" style={{ fontFamily: "'Montserrat', sans-serif" }}>2. Services</h2>
                            <p className="text-base md:text-lg leading-relaxed text-[#4A4A4A]" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                        ...
                        <section>
                            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-[#121010]" style={{ fontFamily: "'Montserrat', sans-serif" }}>3. Quotations and Pricing</h2>
                            <p className="text-base md:text-lg leading-relaxed text-[#4A4A4A]" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                        ...
                        <section>
                            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-[#121010]" style={{ fontFamily: "'Montserrat', sans-serif" }}>4. Payment Terms</h2>
                            <p className="text-base md:text-lg leading-relaxed text-[#4A4A4A]" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                        ...
                        <section>
                            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-[#121010]" style={{ fontFamily: "'Montserrat', sans-serif" }}>5. Warranties</h2>
                            <p className="text-base md:text-lg leading-relaxed text-[#4A4A4A]" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                        ...
                        <section>
                            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-[#121010]" style={{ fontFamily: "'Montserrat', sans-serif" }}>6. Cancellation and Refunds</h2>
                            <p className="text-base md:text-lg leading-relaxed text-[#4A4A4A]" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                        ...
                        <section>
                            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-[#121010]" style={{ fontFamily: "'Montserrat', sans-serif" }}>7. Limitation of Liability</h2>
                            <p className="text-base md:text-lg leading-relaxed text-[#4A4A4A]" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                        ...
                        <section>
                            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-[#121010]" style={{ fontFamily: "'Montserrat', sans-serif" }}>8. Force Majeure</h2>
                            <p className="text-base md:text-lg leading-relaxed text-[#4A4A4A]" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                        ...
                        <section>
                            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-[#121010]" style={{ fontFamily: "'Montserrat', sans-serif" }}>9. Intellectual Property</h2>
                            <p className="text-base md:text-lg leading-relaxed text-[#4A4A4A]" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                        ...
                        <section>
                            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-[#121010]" style={{ fontFamily: "'Montserrat', sans-serif" }}>10. Governing Law</h2>
                            <p className="text-base md:text-lg leading-relaxed text-[#4A4A4A]" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                        ...
                        <section>
                            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-[#121010]" style={{ fontFamily: "'Montserrat', sans-serif" }}>11. Amendments</h2>
                            <p className="text-base md:text-lg leading-relaxed text-[#4A4A4A]" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                        ...
                        <section className="pt-8 border-t border-gray-200">
                            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-[#121010]" style={{ fontFamily: "'Montserrat', sans-serif" }}>12. Contact Information</h2>
                            <p className="text-base md:text-lg leading-relaxed text-[#4A4A4A]" style={{ fontFamily: "'Montserrat', sans-serif" }}>
