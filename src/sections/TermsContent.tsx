                ...
                <FadeIn delay={100} direction="up">
                    <div className="space-y-8 md:space-y-12">
                        ...
                        <section>
                            ...
                            <ul className="list-disc pl-6 mt-2 space-y-1 text-base md:text-lg text-[#4A4A4A]" style={{ fontFamily: "'Poppins', sans-serif" }}>
                        ...
                        <section>
                            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-[#121010]" style={{ fontFamily: "'Poppins', sans-serif" }}>11. Amendments</h2>
                            <p className="text-base md:text-lg leading-relaxed text-[#4A4A4A]" style={{ fontFamily: "'Poppins', sans-serif" }}>
                        ...
                        <section className="pt-8 border-t border-gray-200">
                            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-[#121010]" style={{ fontFamily: "'Poppins', sans-serif" }}>12. Contact Information</h2>
                            <p className="text-base md:text-lg leading-relaxed text-[#4A4A4A]" style={{ fontFamily: "'Poppins', sans-serif" }}>
