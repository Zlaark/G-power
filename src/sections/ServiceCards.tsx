        ...
        <section className="relative w-full bg-white py-[40px] md:py-[60px] lg:py-[80px]">
            <div className="mx-auto max-w-[1920px] px-[20px] md:px-[40px] lg:px-[87px]">
                ...
                <style dangerouslySetInnerHTML={{
                    ...
                    .animate-elegant-pop {
                        opacity: 0;
                        animation: elegantPopIn 1s cubic-bezier(0.16, 1, 0.3, 1) forwards calc(var(--anim-delay, 0s)),
                                   gentleCardFloat 6s ease-in-out infinite calc(var(--anim-delay, 0s) + 1s);
                    }
                    .image-zoom-loop {
                ...
                <div className="flex flex-col lg:flex-row gap-[16px] md:gap-[24px]">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-[16px] md:gap-[24px] flex-shrink-0 w-full lg:w-[750px]">
                        ...
                        <div
                            className="relative bg-[#EF3C38] rounded-[20px] min-h-[250px] md:min-h-[329px] h-full p-[20px] md:p-[20px] lg:p-[30px] overflow-hidden flex flex-col justify-end animate-elegant-pop hover-card-lift group"
                        ...
                        <div
                            className="relative bg-[#EDEDED] rounded-[20px] min-h-[250px] md:min-h-[329px] h-full p-[20px] md:p-[20px] lg:p-[30px] overflow-hidden flex flex-col justify-end animate-elegant-pop hover-card-lift group"
                        ...
                        <div
                            className="relative bg-[#EDEDED] rounded-[20px] min-h-[250px] md:min-h-[329px] h-full overflow-hidden animate-elegant-pop hover-card-lift group"
                    ...
                    <div
                        className="flex-1 rounded-[20px] overflow-hidden min-h-[300px] md:min-h-[682px] animate-elegant-pop relative group w-full"
