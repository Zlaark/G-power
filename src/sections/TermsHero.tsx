    ...
    return (
        <section className="relative w-full h-[50vh] min-h-[360px] bg-[#01050A] overflow-hidden flex justify-center">
            ...
            <div
                ...
                style={{
                    background: "url('https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&q=80&w=1920')",
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
                <FadeIn delay={100} direction="up">
                    <LegalBreadcrumbs currentPage="Terms & Conditions" />
                    <h1
