...
const generalParameters = [
  { key: "Rated Energy", value: "261 kWh" },
  { key: "Rated Power", value: "130 kW" },
  { key: "Operating Voltage Range", value: "850-1200 VDC" },
  { key: "Round Trip Efficiency", value: "≥88%" },
  { key: "Enclosure", value: "IP54" },
];
...
export function UtilityBattery4SpecsSheetSection() {
  return (
