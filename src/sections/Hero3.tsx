        ...
        <section className="relative w-full h-screen overflow-hidden">
            ...
            <div className="absolute inset-0 z-10 w-full max-w-[1920px] mx-auto">
                ...
                <div className="absolute left-[20px] md:left-[86px] top-1/2 -translate-y-1/2 w-[calc(100%-40px)] md:w-[490px] flex flex-col items-start gap-4">
                    <h1
                        className="text-white font-semibold leading-tight md:leading-[84px] w-full m-0 text-left"
                    ...
                    <p
                        className="text-white font-medium leading-normal md:leading-[34px] w-full m-0 text-left"
                    ...
                    <div className="w-[71px] h-[71px] relative mt-4">
