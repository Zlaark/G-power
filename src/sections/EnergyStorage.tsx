...
export const EnergyStorage = () => {
    return (
        <section className="relative w-full bg-white py-[72px] md:py-[92px] lg:py-[112px] overflow-hidden">
            <div className="relative z-10 w-full max-w-[1920px] mx-auto px-[20px] md:px-[60px] lg:px-[100px]">
                ...
                <div className="mt-14 lg:mt-18 grid lg:grid-cols-[1.15fr_0.85fr] gap-8 lg:gap-12 items-center">
                    ...
                    <div className="flex flex-col gap-5">
                        <FadeIn delay={260} direction="up">
                            <div className="rounded-[24px] border border-[#E5EBF2] bg-white p-6 md:p-7 shadow-[0_12px_30px_rgba(15,23,42,0.05)]">
                        ...
                        <FadeIn delay={340} direction="up">
                            <div className="grid sm:grid-cols-2 gap-4">
                                {[
                                    ...
                                    <div key={item.title} className="rounded-[20px] border border-[#E5EBF2] bg-white p-5 shadow-[0_10px_24px_rgba(15,23,42,0.04)]">
                                        <div className="w-10 h-10 rounded-full border border-[#0A5191]/20 flex items-center justify-center mb-4 bg-white">
                                            <div className="w-2.5 h-2.5 rounded-full bg-[#0A5191]" />
                                        </div>
                ...
                <FadeIn delay={460} direction="up">
                    <div className="mt-8 mx-auto max-w-[980px] rounded-[24px] border border-[#E5EBF2] bg-white px-6 md:px-8 py-6 md:py-7 text-center shadow-[0_12px_32px_rgba(15,23,42,0.05)]">
